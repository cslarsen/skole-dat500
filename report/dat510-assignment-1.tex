...
\begin{abstract}
  ...
  substitution cipher, and the educational \textit{Simplified DES} (SDES) asymmetric cipher.
%
  The Vigenère plaintext was deciphered using the \textit{Kasinski method} for
