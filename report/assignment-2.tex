...
\begin{abstract}
  ...
  program between two parties. 
  %
  Each participant generates private and public keys using the Blum Blum Shub
  PRNG, with 256-bit primes that are resistant to subgroup attacks. Suitable
  Blum numbers are found through trial Miller-Rabin primality testing runs.
  %
  ...
  1536-bit parameters from the IKE protocol.
  %
